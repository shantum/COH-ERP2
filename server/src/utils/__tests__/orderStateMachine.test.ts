...
describe('orderStateMachine', () => {
    ...
    describe('isValidTransition - Backward Corrections', () => {
        ...
        it('does NOT allow shipped -> packed (no unship via state machine)', () => {
    ...
    describe('isValidTransition - Invalid Transitions', () => {
        ...
        it('does NOT allow shipped -> anything (terminal for this endpoint)', () => {
            expect(getValidTargetStatuses('shipped')).toEqual([]);
        });
    });
    ...
    describe('getValidTargetStatuses', () => {
        ...
        it('returns empty array for shipped', () => {
            expect(getValidTargetStatuses('shipped')).toEqual([]);
        });
    ...
    describe('buildTransitionError', () => {
        ...
        it('handles shipped status with no targets', () => {
            const error = buildTransitionError('shipped', 'cancelled');
            expect(error).toContain('Allowed: none');
        });
    });
