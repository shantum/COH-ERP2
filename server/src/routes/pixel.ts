...
const storefrontEventSchema = z.object({
    ...
    gadSource: z.string().max(50).optional(),
    gadCampaignId: z.string().max(100).optional(),
    ...
    // Browser context (from pixel script)
    userAgent: z.string().max(500).optional(),
    browserTimezone: z.string().max(100).optional(),
    browserLanguage: z.string().max(50).optional(),
    pageTitle: z.string().max(500).optional(),
    // Parsed by Worker from userAgent
    ...
    continent: z.string().max(10).optional(),
    regionCode: z.string().max(20).optional(),
    // Network / connection (from CF Worker)
    clientIp: z.string().max(50).optional(),
    cfTimezone: z.string().max(100).optional(),
    asOrganization: z.string().max(200).optional(),
    asn: z.number().int().optional(),
    httpProtocol: z.string().max(20).optional(),
    tlsVersion: z.string().max(20).optional(),
...
router.post('/events', asyncHandler(async (req: Request, res: Response) => {
    ...
    const rows = validEvents.map(e => ({
        ...
        ...(e.fbclid ? { fbclid: e.fbclid } : {}),
        ...(e.gclid ? { gclid: e.gclid } : {}),
        ...(e.gbraid ? { gbraid: e.gbraid } : {}),
        ...(e.wbraid ? { wbraid: e.wbraid } : {}),
        ...(e.ttclid ? { ttclid: e.ttclid } : {}),
        ...(e.msclkid ? { msclkid: e.msclkid } : {}),
        ...(e.gadSource ? { gadSource: e.gadSource } : {}),
        ...(e.gadCampaignId ? { gadCampaignId: e.gadCampaignId } : {}),
        ...
        ...(e.browserTimezone ? { browserTimezone: e.browserTimezone } : {}),
        ...(e.browserLanguage ? { browserLanguage: e.browserLanguage } : {}),
        ...
        ...(e.continent ? { continent: e.continent } : {}),
        ...(e.regionCode ? { regionCode: e.regionCode } : {}),
        ...(e.clientIp ? { clientIp: e.clientIp } : {}),
        ...(e.cfTimezone ? { cfTimezone: e.cfTimezone } : {}),
        ...(e.asOrganization ? { asOrganization: e.asOrganization } : {}),
        ...(e.asn ? { asn: e.asn } : {}),
        ...(e.httpProtocol ? { httpProtocol: e.httpProtocol } : {}),
        ...(e.tlsVersion ? { tlsVersion: e.tlsVersion } : {}),
        ...(e.isVpn != null ? { isVpn: e.isVpn } : {}),
        rawData: {
            ...(e.rawData || {}),
