 ...
 */
interface FabricTypeWithFabrics extends FabricType {
 ...
 */
interface FabricWithFabricType {
    id: string;
    name: string;
    colorName: string;
    colorHex: string | null;
 ...
 */
interface ReconciliationItemBasic {
    id: string;
    fabricId: string;
    systemQty: number;
    physicalQty: number | null;
 ...
 */
const statusOrder: Record<StockStatus, number> = { 'ORDER NOW': 0, 'ORDER SOON': 1, 'OK': 2 };
 ...
 */
interface OrderLineWithRelations {
    qty: number;
 ...
 */
interface FabricOrderWithRelations {
    id: string;
    fabricId: string;
 ...
 */
interface ReconciliationItemUpdate {
    id: string;
    physicalQty: number | null;
    systemQty: number;
    adjustmentReason?: string | null;
