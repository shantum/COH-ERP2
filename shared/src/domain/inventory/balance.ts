 ...
 */
export function calculateFabricBalance(
    summary: FabricTransactionSummary
): FabricBalance {
    return {
        totalInward: summary.totalInward,
        totalOutward: summary.totalOutward,
 ...
 */
export function getAllocatableQuantity(
    balance: InventoryBalance,
    requestedQty: number
): number {
 ...
 */
export function createEmptyBalanceWithId(skuId: string): InventoryBalanceWithSkuId {
    return {
        skuId,
        totalInward: 0,
        totalOutward: 0,
 ...
 */
export function createEmptyFabricBalanceWithId(fabricId: string): FabricBalanceWithId {
    return {
        fabricId,
        totalInward: 0,
        totalOutward: 0,
