 ...
 */
export function calculateTierFromLtv(ltv, thresholds = DEFAULT_TIER_THRESHOLDS) {
    if (ltv >= thresholds.platinum)
        return 'platinum';
    if (ltv >= thresholds.gold)
        return 'gold';
    if (ltv >= thresholds.silver)
        return 'silver';
    return 'bronze';
}
// ============================================
 ...
 * @returns true if a > b
 */
export function isTierHigher(a, b) {
 ...
 * @returns true if a < b
 */
export function isTierLower(a, b) {
    return compareTiers(a, b) < 0;
}
// ============================================
 ...
 */
export function shouldUpgradeTier(currentTier, newLtv, thresholds = DEFAULT_TIER_THRESHOLDS) {
 ...
 */
export function shouldDowngradeTier(currentTier, newLtv, thresholds = DEFAULT_TIER_THRESHOLDS) {
    const newTier = calculateTierFromLtv(newLtv, thresholds);
    return compareTiers(newTier, currentTier) < 0;
}
/**
 ...
 */
export function getTierChange(currentTier, newLtv, thresholds = DEFAULT_TIER_THRESHOLDS) {
    const newTier = calculateTierFromLtv(newLtv, thresholds);
 ...
 */
export function getMinLtvForTier(tier, thresholds = DEFAULT_TIER_THRESHOLDS) {
    switch (tier) {
        case 'platinum':
 ...
 */
export function getAmountToNextTier(currentLtv, thresholds = DEFAULT_TIER_THRESHOLDS) {
