...
export { getProductById, type ProductDetailResponse, type VariationDetailResponse, type SkuDetailResponse, type MeasurementData, type SizeEquivalent, type ShopifyProductData } from './detail';
