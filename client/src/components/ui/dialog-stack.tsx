...
export const DialogStackBody = ({
  ...
  // Count only valid React elements (excludes null, undefined, booleans)
  ...
  const [totalDialogs, setTotalDialogs] = useState(validChildCount);
  ...
  return (
    ...
    >
      <PortalPrimitive.Root>
        <div
          className={cn(
            'pointer-events-none fixed inset-0 z-50 mx-auto flex w-full max-w-2xl flex-col items-center justify-center p-4',
            className
          )}
          {...props}
        >
          <div className="pointer-events-auto relative flex w-full flex-col items-center justify-center">
            {(() => {
              ...
              return Children.map(children, (child) => {
                // Skip null, undefined, or non-element children
